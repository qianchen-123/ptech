...
proc create_hier_cell_StreamingFCLayer_Batch_3 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   CONFIG.MEM_DEPTH {8} \
   CONFIG.MEM_INIT {/tmp/finn_dev_zqc/code_gen_ipgen_StreamingFCLayer_Batch_3_53sp3pd3/} \
   CONFIG.MEM_WIDTH {80} \
   CONFIG.NSTREAMS {1} \
   CONFIG.RAM_STYLE {distributed} \
   CONFIG.STRM0_DEPTH {8} \
...
proc create_hier_cell_StreamingFCLayer_Batch_2 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   CONFIG.MEM_DEPTH {64} \
   CONFIG.MEM_INIT {/tmp/finn_dev_zqc/code_gen_ipgen_StreamingFCLayer_Batch_2_u1ro_kgj/} \
   CONFIG.MEM_WIDTH {64} \
   CONFIG.NSTREAMS {1} \
...
proc create_hier_cell_StreamingFCLayer_Batch_1 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   CONFIG.MEM_DEPTH {64} \
   CONFIG.MEM_INIT {/tmp/finn_dev_zqc/code_gen_ipgen_StreamingFCLayer_Batch_1_wiks4x6a/} \
   CONFIG.MEM_WIDTH {64} \
   CONFIG.NSTREAMS {1} \
   CONFIG.RAM_STYLE {auto} \
   CONFIG.STRM0_DEPTH {64} \
...
proc create_hier_cell_StreamingFCLayer_Batch_0 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   CONFIG.MEM_DEPTH {64} \
   CONFIG.MEM_INIT {/tmp/finn_dev_zqc/code_gen_ipgen_StreamingFCLayer_Batch_0_4jguye4c/} \
   CONFIG.MEM_WIDTH {784} \
   CONFIG.NSTREAMS {1} \
   CONFIG.RAM_STYLE {block} \
   CONFIG.STRM0_DEPTH {64} \
   CONFIG.STRM0_OFFSET {0} \
   CONFIG.STRM0_WIDTH {784} \
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net StreamingDataWidthConverter_Batch_0_out_V_V [get_bd_intf_pins StreamingDataWidthConverter_Batch_0/out_V_V] [get_bd_intf_pins StreamingFIFO_3/in0_V_V]
  connect_bd_intf_net -intf_net StreamingDataWidthConverter_Batch_1_out_V_V [get_bd_intf_pins LabelSelect_Batch_0/in0_V_V] [get_bd_intf_pins StreamingDataWidthConverter_Batch_1/out_V_V]
  ...
  connect_bd_intf_net -intf_net StreamingFCLayer_Batch_1_out_V_V [get_bd_intf_pins StreamingFCLayer_Batch_1/out_V_V] [get_bd_intf_pins StreamingFIFO_4/in0_V_V]
  ...
  connect_bd_intf_net -intf_net StreamingFCLayer_Batch_3_out_V_V [get_bd_intf_pins StreamingDataWidthConverter_Batch_1/in0_V_V] [get_bd_intf_pins StreamingFCLayer_Batch_3/out_V_V]
  ...
  connect_bd_intf_net -intf_net StreamingFIFO_3_out_V_V [get_bd_intf_pins StreamingFCLayer_Batch_1/in0_V_V] [get_bd_intf_pins StreamingFIFO_3/out_V_V]
  connect_bd_intf_net -intf_net StreamingFIFO_4_out_V_V [get_bd_intf_pins StreamingFCLayer_Batch_2/in0_V_V] [get_bd_intf_pins StreamingFIFO_4/out_V_V]
  ...
  # Create port connections
  connect_bd_net -net ap_clk_0_1 [get_bd_ports ap_clk] [get_bd_pins LabelSelect_Batch_0/ap_clk] [get_bd_pins StreamingDataWidthConverter_Batch_0/ap_clk] [get_bd_pins StreamingDataWidthConverter_Batch_1/ap_clk] [get_bd_pins StreamingFCLayer_Batch_0/ap_clk] [get_bd_pins StreamingFCLayer_Batch_1/ap_clk] [get_bd_pins StreamingFCLayer_Batch_2/ap_clk] [get_bd_pins StreamingFCLayer_Batch_3/ap_clk] [get_bd_pins StreamingFIFO_0/ap_clk] [get_bd_pins StreamingFIFO_1/ap_clk] [get_bd_pins StreamingFIFO_3/ap_clk] [get_bd_pins StreamingFIFO_4/ap_clk] [get_bd_pins Thresholding_Batch_0/ap_clk]
  connect_bd_net -net ap_rst_n_0_1 [get_bd_ports ap_rst_n] [get_bd_pins LabelSelect_Batch_0/ap_rst_n] [get_bd_pins StreamingDataWidthConverter_Batch_0/ap_rst_n] [get_bd_pins StreamingDataWidthConverter_Batch_1/ap_rst_n] [get_bd_pins StreamingFCLayer_Batch_0/ap_rst_n] [get_bd_pins StreamingFCLayer_Batch_1/ap_rst_n] [get_bd_pins StreamingFCLayer_Batch_2/ap_rst_n] [get_bd_pins StreamingFCLayer_Batch_3/ap_rst_n] [get_bd_pins StreamingFIFO_0/ap_rst_n] [get_bd_pins StreamingFIFO_1/ap_rst_n] [get_bd_pins StreamingFIFO_3/ap_rst_n] [get_bd_pins StreamingFIFO_4/ap_rst_n] [get_bd_pins Thresholding_Batch_0/ap_rst_n]
