...
module StreamingFCLayer_Batch_0_imp_5FXKV0
  ...
  assign in0_V_V_1_TDATA = in0_V_V_tdata[55:0];
  assign in0_V_V_1_TVALID = in0_V_V_tvalid;
  assign in0_V_V_tready = in0_V_V_1_TREADY;
  assign out_V_V_tdata[15:0] = StreamingFCLayer_Batch_0_out_V_V_TDATA;
...
module StreamingFCLayer_Batch_2_imp_1YXLQV7
  ...
  wire [63:0]StreamingFCLayer_Batch_2_wstrm_m_axis_0_TDATA;
...
module StreamingFCLayer_Batch_3_imp_RR03E4
  ...
  wire [79:0]StreamingFCLayer_Batch_3_out_V_V_TDATA;
  wire StreamingFCLayer_Batch_3_out_V_V_TREADY;
  wire StreamingFCLayer_Batch_3_out_V_V_TVALID;
  wire [79:0]StreamingFCLayer_Batch_3_wstrm_m_axis_0_TDATA;
  ...
  assign in0_V_V_1_TVALID = in0_V_V_tvalid;
  assign in0_V_V_tready = in0_V_V_1_TREADY;
  assign out_V_V_tdata[79:0] = StreamingFCLayer_Batch_3_out_V_V_TDATA;
...
(* CORE_GENERATION_INFO = "finn_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=finn_design,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=20,numReposBlks=16,numNonXlnxBlks=0,numHierBlks=4,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=8,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "finn_design.hwdef" *) 
module finn_design
   (ap_clk,
    ap_rst_n,
    m_axis_0_tdata,
  ...
  wire StreamingFCLayer_Batch_3_out_V_V_TREADY;
  wire StreamingFCLayer_Batch_3_out_V_V_TVALID;
  wire [391:0]StreamingFIFO_0_out_V_V_TDATA;
  wire StreamingFIFO_0_out_V_V_TREADY;
  wire StreamingFIFO_0_out_V_V_TVALID;
  wire [55:0]StreamingFIFO_1_out_V_V_TDATA;
  ...
  assign in0_V_V_0_1_TDATA = s_axis_0_tdata[391:0];
