...
wire   [10:0] t_fu_110_p2;
reg   [0:0] icmp_ln479_reg_175;
wire   [31:0] select_ln490_fu_134_p3;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state2;
reg   [23:0] ap_phi_mux_p_Val2_s_phi_fu_98_p4;
wire   [23:0] ap_phi_reg_pp0_iter0_p_Val2_s_reg_95;
reg   [23:0] ap_phi_reg_pp0_iter1_p_Val2_s_reg_95;
wire   [23:0] zext_ln476_fu_142_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln476_reg_166 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        p_025_0_reg_61 <= {{ap_phi_mux_p_Val2_s_phi_fu_98_p4[23:4]}};
    end else if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        p_025_0_reg_61 <= 20'd0;
    end
end
...
assign icmp_ln476_fu_104_p2 = ((t_0_reg_84 == 11'd1176) ? 1'b1 : 1'b0);

assign icmp_ln479_fu_116_p2 = ((o_0_reg_73 == 32'd0) ? 1'b1 : 1'b0);

assign icmp_ln490_fu_128_p2 = ((o_fu_122_p2 == 32'd6) ? 1'b1 : 1'b0);
...
assign t_fu_110_p2 = (t_0_reg_84 + 11'd1);
