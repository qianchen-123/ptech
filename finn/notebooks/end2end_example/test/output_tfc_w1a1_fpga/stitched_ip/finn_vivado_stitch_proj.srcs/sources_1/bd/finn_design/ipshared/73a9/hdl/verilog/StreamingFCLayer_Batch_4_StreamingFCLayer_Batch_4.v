...
(* CORE_GENERATION_INFO="StreamingFCLayer_Batch_4_StreamingFCLayer_Batch_4,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xqrku060-cna1509-1M-m,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.378000,HLS_SYN_LAT=845,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=445,HLS_SYN_LUT=861,HLS_VERSION=2020_1}" *)
...
StreamingFCLayer_Batch_4_Matrix_Vector_Activa grp_Matrix_Vector_Activa_fu_28(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
