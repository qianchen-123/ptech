...
initial begin
    $readmemh("/tmp/finn_dev_zqc/code_gen_ipgen_StreamingFCLayer_Batch_0_vlxpbv0l/project_StreamingFCLayer_Batch_0/sol1/impl/ip/hdl/verilog/StreamingFCLayer_Batch_0_Matrix_Vector_ActeOg_rom.dat", ram);
end
