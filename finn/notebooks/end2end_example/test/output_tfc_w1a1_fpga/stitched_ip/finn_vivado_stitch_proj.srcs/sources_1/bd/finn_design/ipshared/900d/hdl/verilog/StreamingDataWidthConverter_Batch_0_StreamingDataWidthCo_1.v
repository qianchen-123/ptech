...
wire   [14:0] t_fu_102_p2;
wire   [99:0] p_Result_s_fu_115_p3;
reg   [99:0] p_Result_s_reg_178;
wire   [0:0] icmp_ln517_fu_129_p2;
wire   [95:0] trunc_ln_fu_150_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln508_fu_96_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        icmp_ln517_reg_183 <= icmp_ln517_fu_129_p2;
        p_Result_s_reg_178 <= p_Result_s_fu_115_p3;
    end
end
...
always @ (*) begin
    if (((icmp_ln517_reg_183 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln517_reg_183 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        out_V_V_TVALID = 1'b1;
    end else begin
        out_V_V_TVALID = 1'b0;
    end
...
always @ (*) begin
    ap_block_state3_io = ((icmp_ln517_reg_183 == 1'd1) & (out_V_V_TREADY == 1'b0));
end
...
assign icmp_ln508_fu_96_p2 = ((t_0_reg_80 == 15'd19600) ? 1'b1 : 1'b0);

assign icmp_ln517_fu_129_p2 = ((i_fu_123_p2 == 32'd25) ? 1'b1 : 1'b0);

assign out_V_V_TDATA = p_Result_s_reg_178;

assign p_Result_s_fu_115_p3 = {{tmp_V_fu_111_p1}, {r_V_reg_69}};

assign t_fu_102_p2 = (t_0_reg_80 + 15'd1);

assign tmp_1_fu_140_p4 = {{r_V_reg_69[95:4]}};
